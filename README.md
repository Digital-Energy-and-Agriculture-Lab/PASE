...
# Default read me file below that
...
```
cd existing_repo
git remote add origin https://gitlab.uliege.be/deal/framework_agrivoltaics.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.uliege.be/deal/framework_agrivoltaics/-/settings/integrations)
