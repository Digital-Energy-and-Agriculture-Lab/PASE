...
class PV_Configuration_3D:
    ...
    def create_block_of_panels(self, fst_panel,diff_row_end,fst_diffuser):
        ...
        ydf = self.repet_dist_panels_y * np.arange(-(self.n_panels_y+row_end_corr - 1) / 2, (self.n_panels_y+row_end_corr + 1) / 2)
    ...
    def create_central(self, PV_block_polydata, fst_panel=None, xyz_block=None):
        ...
        PV_central_polydata['type'] = PV_block_polydata['type']*self.n_blocks_x*self.n_blocks_y
