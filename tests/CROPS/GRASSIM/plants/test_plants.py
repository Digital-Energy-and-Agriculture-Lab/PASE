...
def test_interval_fT ():
    ...
    inits={'BMDR': 0.0, 'BMDV': 250.0, 'BMGR': 0.0, 'BMGV': 1000.0, 'BM_init_type': 'InitialBM', 'InitialHeight': 0.05, 'Tstop':30,'Tmax': 18, 'Tmin': 0, 'ageDR': 0, 'ageDV': 0, 'ageGR': 0, 'ageGV': 0, 'apex_grazed': 0}
